...
if not APP_ID:
    raise RuntimeError("APP_ID is not set. Please define APP_ID in your .env file.")

print("Downloading exchange info from https://openexchangerates.org/api")

rpp = requests.get(f"https://openexchangerates.org/api/latest.json?app_id={APP_ID}")
